...
=======
    ...
    >
      <div className="flex flex-col md:flex-row items-center justify-center bg-white shadow-lg rounded-lg overflow-hidden max-w-5xl w-full h-[80vh]">
        {/* 🔸 Left side image */}
         <div className="hidden md:flex w-1/2 h-full p-6">
          <img
            src={loginImage}
            alt="Login Visual"
